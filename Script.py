...
𝖢𝗅𝗂𝖼𝗄 <b>/help or Help</b> 𝗍𝗈 𝗆𝗒 𝖥𝗎𝗇𝖼𝗍𝗂𝗈𝗇𝗌</a>"""
    ...
    ABOUT_TXT = """<b>○ 𝖬𝗒 𝖭𝖺𝗆𝖾: {}
○ 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href='https://t.me/Naritu26'>𝖳𝗁𝗂𝗌 𝖯𝖾𝗋𝗌𝗈𝗇</a>
○ 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥 
...
- <a href=https://t.me/Naritu26>『ɴᴀʀɪᴛᴜ』</a>"""
...
○ 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉 : <a href='https://t.me/FilmPirateOfficial'>𝖳𝖺𝗉 𝖧𝖾𝗋𝖾</a>
"""
...
Message <b>: {}</b>"""
    ...
    CAPTION = """
📂 <em>File Name</em>: <code>[FP]{file_name}</code>⚙️ Mᴏᴠɪᴇ Sɪᴢᴇ: {file_size}</code>"""

    IMDB_TEMPLATE_TXT = """
👋𝗛ᴇʟʟᴏ {message.from_user.mention} Ⴤᴏᴜʀ 𝙼𝚘ᴠᴇ
